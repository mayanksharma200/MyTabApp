...
import { setToken, clearToken } from "../store/"; // Adjust path
import { setUser, clearUser } from "../store/authSlice"; // Adjust path or remove if no user slice
...
export default function Navbar() {
  ...
  const user = useSelector((state) => state.user.data); // Adjust if you have user slice
  ...
  return (
    <View style={styles.navbar}>
      ...
      {windowWidth < 600 ? (
        ...
        // Show nav items inline on larger screens
      ...
      {/* Dropdown menu for small screens or user menu */}
