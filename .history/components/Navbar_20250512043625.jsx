...
const styles = StyleSheet.create({
  navbar: {
    paddingTop: Platform.OS === "ios" ? 30 : 10, // reduced top padding
    paddingBottom: Platform.OS === "ios" ? 10 : 10, // add bottom padding for height control
    ...
    // Optional: add gradient background using linear-gradient library or fallback solid color
  },
  logo: {
    fontSize: 26,
    fontWeight: "900",
...
hamburger: {
  ...
  navItems: {
    ...
    flex: 2, // allow nav items to take space next to logo
  },
  navItem: {
    marginHorizontal: 14,
    paddingVertical: 10,
